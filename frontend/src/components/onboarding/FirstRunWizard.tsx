        ...
        <div className="grid gap-4 p-5 lg:grid-cols-[220px_minmax(0,1fr)]">
          ...
          <section className="min-h-[420px] space-y-4">
            ...
            {step === 1 && <div className="space-y-4">
              ...
              <div className="grid gap-3 sm:grid-cols-2"><label className="text-sm text-slate-300">{t('common.name')}<input className="mt-1 w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2" value={modelName} onChange={(event) => setModelName(event.target.value)} /></label><label className="text-sm text-slate-300">Model ID<input className="mt-1 w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2" value={modelId} onChange={(event) => setModelId(event.target.value)} placeholder={PROVIDER_MODEL_PLACEHOLDERS[provider]} /></label></div>
              <label className="block text-sm text-slate-300">Base URL<input className="mt-1 w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2" value={baseUrl} onChange={(event) => setBaseUrl(event.target.value)} placeholder={PROVIDER_PRESETS[provider] || 'https://example.com/v1'} /></label>
