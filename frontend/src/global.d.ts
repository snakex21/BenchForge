...
interface BenchForgeDesktopApi {
  ...
  scanBenchmarkBeacon: (payload: { url: string }) => Promise<{ ok: boolean; id: string; owner: string; repo: string; ref: string; name: string; description: string; version?: string | null; author?: string | null; license?: string | null; source: string; repoUrl: string; homepage?: string; manifestPath: string; beaconPath?: string | null; benchmarks: Array<Record<string, unknown> & { tasks?: Array<Record<string, unknown>> }>; benchmarkCount: number; taskCount: number }>
  discoverBenchmarkBeacons: (payload?: { topic?: string; limit?: number }) => Promise<{ ok: boolean; topic: string; total: number; packs: Array<{ ok: boolean; id: string; owner: string; repo: string; ref: string; name: string; description: string; version?: string | null; author?: string | null; license?: string | null; source: string; repoUrl: string; homepage?: string; manifestPath: string; beaconPath?: string | null; benchmarks: Array<Record<string, unknown> & { tasks?: Array<Record<string, unknown>> }>; benchmarkCount: number; taskCount: number }>; errors: Array<{ repo: string; error: string }> }>
